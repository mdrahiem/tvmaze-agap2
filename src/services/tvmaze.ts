...
import type { EpisodeDetailsResponse, SearchShowResponse, ShowDetailsResponse, ShowEpisodesResponse } from './schema'
...
export const { useGetShowsListQuery, useGetShowDetailsQuery, useGetShowEpisodesQuery, useGetEpisodeDetailsQuery } = tvMazeApi
