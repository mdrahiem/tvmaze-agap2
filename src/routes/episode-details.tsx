  ...
  return (
    <div>
      {episodeDetailsError ? (
        ...
        <div>
          <BackLink link={`/show/${showId}`}>Back to episodes list</BackLink>
          <EpisodeDetailsImage>
            <img src={episodeData?.image?.original ?? NoImage} alt="" />
          </EpisodeDetailsImage>
          ...
          <div
            ...
            <div style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
              ...
              <span>{episodeData?.airdate ? episodeData?.airdate : '-'}</span>
            </div>
            <div style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
              <label>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span>{episodeData?.airtime ? episodeData.airtime : '-'}</span>
            </div>
            <div style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
              <label>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span>{episodeData?.runtime ? episodeData?.runtime : '-'}</span>
            </div>
          </div>
          <div style={{ fontSize: '1.2rem' }}>{summaryText}</div>
        </div>
      )}
    </div>
  )
...
const EpisodeDetailsImage = styled.div({
  display: 'flex',
